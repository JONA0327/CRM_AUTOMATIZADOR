...
$widthClass = [
    ...
    '2xl' => 'app-modal__dialog--2xl',
][$maxWidth] ?? 'app-modal__dialog--md';
@endphp
...
>
    <div
        x-show="show"
        class="app-modal__overlay transform transition-all"
    ...
    <div
        x-show="show"
        class="app-modal__dialog {{ $widthClass }} transform transition-all"
        x-transition:enter="ease-out duration-300"
